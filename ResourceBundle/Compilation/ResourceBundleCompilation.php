...
use Symfony\Component\Icu\ResourceBundle\Compilation\Rule\CompilationRuleInterface;
use Symfony\Component\Icu\ResourceBundle\Writer\PhpBundleWriter;
 ...
 */
class ResourceBundleCompilation
{
    /**
     * @var CompilationRuleInterface[]
     */
    private $rules = array();
     ...
     *
     * @param CompilationRuleInterface $rule The compilation rule.
     */
    public function addRule(CompilationRuleInterface $rule)
    {
        $this->rules[] = $rule;
    }
     ...
     */
    public function run(CompilationContextInterface $context)
    {
