...
use Symfony\Component\Icu\ResourceBundle\Writer\TextBundleWriter;
 ...
 */
class LocaleBundleCompilationRule implements CompilationRuleInterface
{
    /**
     * @var \Symfony\Component\Icu\ResourceBundle\LanguageBundleInterface
     */
    private $languageBundle;

    /**
     * @var \Symfony\Component\Icu\ResourceBundle\RegionBundleInterface
     */
    private $regionBundle;

    public function __construct()
    {
        $this->languageBundle = Icu::getLanguageBundle();
        $this->regionBundle = Icu::getRegionBundle();
    }
    ...
    private function generateTextFiles($targetDirectory, array $locales)
    {
        $displayLocales = array_unique(array_merge(
            $this->languageBundle->getAvailableLocales(),
            $this->regionBundle->getAvailableLocales()
        ));
