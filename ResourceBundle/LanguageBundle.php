 ...
 */
class LanguageBundle extends AbstractResourceBundle implements LanguageBundleInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->readEntry($locale, 'Languages');
    }
    ...
    {
        return $this->readMergedEntry($locale, 'Scripts');
    }
}
