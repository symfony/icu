...
class AbstractBundleReaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->reader = $this->getMockForAbstractClass('Symfony\Component\Icu\ResourceBundle\Reader\AbstractBundleReader');
    ...
    public function testReadLocales()
    {
        ...
        $this->assertSame($sortedLocales, $this->reader->readLocales($this->directory));
    }
}
